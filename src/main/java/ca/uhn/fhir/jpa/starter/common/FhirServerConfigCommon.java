...
public class FhirServerConfigCommon {
   ...
   */
  @Bean
  public JpaStorageSettings daoConfig(AppProperties appProperties) {
  ...
  protected StorageSettings storageSettings(AppProperties appProperties, JpaStorageSettings jpsStorageSettings) {
    jpsStorageSettings.setAllowContainsSearches(appProperties.getAllow_contains_searches());
    jpsStorageSettings.setAllowExternalReferences(appProperties.getAllow_external_references());
    jpsStorageSettings.setDefaultSearchParamsCanBeOverridden(appProperties.getAllow_override_default_search_params());
    if(appProperties.getSubscription() != null && appProperties.getSubscription().getEmail() != null)
    jpsStorageSettings.setEmailFromAddress(appProperties.getSubscription().getEmail().getFrom());

    jpsStorageSettings.setNormalizedQuantitySearchLevel(appProperties.getNormalized_quantity_search_level());

    jpsStorageSettings.setIndexOnContainedResources(appProperties.getEnable_index_contained_resource());
    jpsStorageSettings.setIndexIdentifierOfType(appProperties.getEnable_index_of_type());
    return jpsStorageSettings;
  }
